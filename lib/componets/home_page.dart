...
import 'package:swishapp/pages/admin_cp.dart';
                              ...
                              child: GridView.builder(
                                ...
                                itemBuilder: (BuildContext ctx, index) {
                                  return Gridelementshome(
                                      ...
                                      snp.data.docs[index]['stars'] + .0,
                                      snp.data.docs[index]['image'],
                                      snp.data.docs[index]['name'],
                                      snp.data.docs[index]['like'],
                                      snp.data.docs[index]['rating'],
                                      snp.data.docs[index]['subtitle'],
                                      snp.data.docs[index]['price']);
                                },
                              ));
                        }
                      }),
...
class Gridelementshome extends StatelessWidget {
  ...
  Gridelementshome(this.id, this.rating, this.image, this.title, this.click,
          ...
          InkWell(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => ProductDescription.seif(id, 'flashdeals')));
            },
            child: Container(
              height: 85,
